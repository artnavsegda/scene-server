...
export const analogMap = new Map([
	["[Light][Hall]Ceiling[L2-1][Level]", 1],
	["[Light][Hall]Bra[L2-1/1][Level]", 2],
	["[Light][Hall]LED[L2-2][Level]", 3],
	["[Light][Hall]Ceiling[L2-3][Level]", 4],
	["[Light][Hall]LED[L2-4/1][Level]", 5],
	["[Light][Hall]LED[L2-4/2][Level]", 6],
	["[Light][Hall]Lamp[L2-5][Level]", 7],
	["[Light][Hall]LED[L2-6][Level]", 8],
	["[Light][Living_room]Luster[L3-1][Level]", 9],
	["[Light][Living_room]LED[L3-2][Level]", 10],
	["[Light][Living_room]LED[L3-3][Level]", 11],
	["[Light][Living_room]LED[L3-4][Level]", 12],
	["[Light][Kitchen]Luster[L4-1][Level]", 13],
	["[Light][Kitchen]Built-in[L4-2][Level]", 14],
	["[Light][Kitchen]LED[L4-2/1][Level]", 15],
	["[Light][Kitchen]Built-in[L4-3][Level]", 16],
	["[Light][Bathroom]Bra[L5-1][Level]", 17],
	["[Light][Bathroom]Luster[L5-2][Level]", 18],
	["[Light][Bedroom]Luster[L6-1][Level]", 19],
	["[Light][Bedroom]LED[L6-3][Level]", 20],
	["[Light][Bedroom]Bra[L6-5][Level]", 21],
	["[Light][Bedroom]LED[L6-6][Level]", 22],
	["[Light][Bedroom]Bra[L6-7][Level]", 23],
	["[Light][Bedroom]Bra[L6-8][Level]", 24],
	["[Light][Bedroom]Outlet[L6-9][Level]", 25],
	["[Light][Bedroom]Outlet[L6-10][Level]", 26],
	["[Light][Kids_room]Ceiling[L7-1][Level]", 27],
	["[Light][Kids_room]Ceiling[L7-2][Level]", 28],
	["[Light][Kids_room]Bra[L7-3][Level]", 29],
	["[Light][Kids_room]Bra[L7-4][Level]", 30],
	["[Light][Kids_room]Ceiling[L7-5][Level]", 31],
	["[Light][Kids_room]Ceiling[L7-6][Level]", 32],
	["[Light][Kids_room]Bra[L7-7][Level]", 33],
	["[Light][Kids_room]Bra[L7-8][Level]", 34],
	["[Light][Bedroom_bathroom]Ceiling[L8-1][Level]", 35],
	["[Light][Kids_room_bathroom]Ceiling[L9-1][Level]", 36],
	["[Light][Hall]Bra[L10-1][Level]", 37],
	["[Light][Hall]Ceiling[L10-2][Level]", 38],
	["[Light][Cabinet]Ceiling[L11-1][Level]", 39],
	["[Light][Cabinet]Ceiling[L11-2][Level]", 40],
	["[Light][Cabinet]Bra[L11-3][Level]", 41],
	["[Light][Cabinet]LED[L11-4][Level]", 42],
	["[Light][Cabinet]Luster[Ll3][Level]", 43],
	["[Light][Hall]Bra[L12-1][Level]", 44],
	["[Light][Bathroom]Lamp[L13-1][Level]", 45],
	["[Light][Bathroom][L13-3][Level]", 46],
	["[Light][Bathroom]LED[L13-4][Level]", 47],
	["[Light][1st_level]Lamp[L14-1][Level]", 48],
	["[Light][1st_level]Lamp[L14-2][Level]", 49],
	["[Light][1st_level]Bra[L14-3][Level]", 50],
	["[Light][1st_level]Bra[L14-4][Level]", 51],
	["[Light][Balcony]Lamp[L15-1][Level]", 52],
	["[Light][Stairs]Bra[Ll1][Level]", 53],
	["[Light][Stairs]Bra[Ll2][Level]", 54],
])